...
function buildSubAgentInput(taskMessage: VirtualMessage, parentSessionKey: string) {
  return [
    ...
    'Use: { "headline", "summary", "status", "keyEvidence", "risks", "nextStep", "facts", "openQuestions", "recommendedAction", "draftReply" }.',
    "Keep it dense: one headline, up to 3 evidence bullets, up to 2 risks, one next step.",
